...
<body>
  ...
  <div class="content">
    ...
    <div>
      <a href="../PHP/login.php"><button type="button">
          <span></span>Log in</button></a>
      <a href="../PHP/register.php"> <button type="button"><span></span>Sign up</button></a>
    </div>
  </div>
  </section>
